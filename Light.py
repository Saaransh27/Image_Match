...
def generateScore(image1, image2_folder):
    img1 = imageEncoder(image1)

    similarity_scores = {}

    for image_file in os.listdir(image2_folder):
        image2_path = os.path.join(image2_folder, image_file)
...
if image1_upload and image2_folder_path:
    ...
    if image1 is not None and os.path.isdir(image2_folder_path):
        scores_dict = generateScore(image1, image2_folder_path)
